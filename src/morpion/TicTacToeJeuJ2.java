...
public class TicTacToeJeuJ2 {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					TicTacToeJeuJ2 window = new TicTacToeJeuJ2();
	...
	private void initialize() {
		...
		txtInterface.setText("Interface de " + Joueurs.Joueur2.getNom());
		...
		for(int i = 0; i<9; i++){
		   ...
		   btnNewButton_i.addMouseListener(new MouseAdapter() {
				...
				public void mouseClicked(MouseEvent e) {
					char signe = Joueurs.Joueur2.getSigne();
