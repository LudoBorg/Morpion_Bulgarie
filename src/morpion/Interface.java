   ...
   class DrawCanvas extends JPanel {
      ...
      public void paintComponent(Graphics g) {  // invoke via repaint()
         ...
         if (currentState == GameState.PLAYING) {
            ...
            statusBar.setText("Egalité, cliquez pour rejouer");
         } else if (currentState == GameState.CROSS_WON) {
            statusBar.setForeground(Color.RED);
            statusBar.setText("'X' a gagné ! Cliquez pour rejouer.");
         } else if (currentState == GameState.NOUGHT_WON) {
            statusBar.setForeground(Color.RED);
            statusBar.setText("'O' a gagné ! Cliquez pour rejouer.");
         }
      }
   }
...
//		    fenetre.setTitle("Morpion - Tic Tac Toe");
//		    //Définit sa taille : 400 pixels de large et 100 pixels de haut
//		    fenetre.setSize(400, 400);
//		    //Nous demandons maintenant à notre objet de se positionner au centre
//		    fenetre.setLocationRelativeTo(null);
//		    // Enleve la possibilitée de mettre la fenêtre en grand
//		    fenetre.setResizable(false);
//		    //Termine le processus lorsqu'on clique sur la croix rouge
//		    fenetre.setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
//		    //Pour mettre du texte dans l'interface graphique
//		    fenetre.setLayout(new FlowLayout());
//		    JLabel label = new JLabel("Bienvenue dans le jeu du Tic-Tac-Toe de Ludovic Borgagni");
//		    fenetre.add(label);
//		    
//		    JTextArea  textArea1 = new JTextArea ("Login");
